...
[consequenec][][Ii]nclude the [Rr]eason for [Ss]hot {refer_oTargetDose} [Vv]alid due to "Outside Season"={refer_oTargetDose}.addValidReason("EVALUATION_REASON_CONCEPT.OUTSIDE_SEASON");
